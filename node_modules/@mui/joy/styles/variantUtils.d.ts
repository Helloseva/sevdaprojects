...
}, addDefaultValues?: boolean) => Record<DefaultColorPalette, CSSObject>;
export declare const createSolidInversion: (theme: ThemeFragment, addDefaultValues?: boolean) => Record<DefaultColorPalette, CSSObject>;
export {};
